...
def kstest_ellipsis(a):
    with open(f'ellipsis_{a}_read.csv','r',encoding='utf-8')as f:
        data=f.readlines()
...
def kstest_complete(a):
    with open(f'complete_{a}_read.csv','r',encoding='utf-8')as f:
        data=f.readlines()
        flesch_reading_eases=[]
        flesch_kincaid_grades=[]
        coleman_liau_indexs=[]
...
if __name__=='__main__':
    ...
    for a in name:
        ...
        with open(f'complete_{a}_read.csv','r',encoding='utf-8')as ff:
            wrel0s=[]
            wrel1s=[]
            wrel2s=[]
            wrel3s=[]
