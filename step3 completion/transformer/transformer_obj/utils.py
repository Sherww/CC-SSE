...
configs = {
    "train_source_data":"./data/train_obj.code",
    "train_target_data":"./data/train_obj.comm",
    "valid_source_data":"./data/test_obj.code",
    "valid_target_data":"./data/test_obj.comm",
    ...
    "print_freq": 5,
    "beam_size":3,
    "model_path":"./model_transformer_translate_obj.pt",
    "early_stopping":15
}
