...
# with open('test_obj.comm','r',encoding='utf-8')as f:
#     test=f.readlines()
# with open('predict_test.txt','r',encoding='utf-8')as ff:
#     res=ff.readlines()
#     result=[]
#     for da in res:
#         da=da.replace('.',' ')
...
def obj():
    ...
    print(len(nee2s))
    print(len(codes2))
    # with open('D:\\short_comment\\step3 completion\\transformer\\transformer-main_obj\\data\\yizhi_result\\result_obj_all_succ_or_fail.txt','w',encoding='utf-8')as f0:
    #     succ=[]
    #     # fail=[]
    ...
    # with open('D:\\short_comment\\step3 completion\\transformer\\transformer-main_obj\\data\\yizhi_result\\result_obj_yizhi.txt','w',encoding='utf-8')as f2:
    #     a=[]
    #     b=[]
    #     c=[]
    #     d=[]
    ...
    # with open('D:\\short_comment\\step3 completion\\transformer\\transformer-main_obj\\data\\yizhi_result\\result_yizhi_obj.txt','w',encoding='utf-8')as f3:
