...
python run.py --do_train --do_eval --model_type roberta --model_name_or_path ../../codebert-base  --train_filename ../dataset/java/train.jsonl --dev_filename ../dataset/java/valid.jsonl --output_dir model/java --max_source_length 128 --max_target_length 16 --beam_size 5 --train_batch_size 64 --eval_batch_size 64 --learning_rate 5e-5 --num_train_epochs 50  > output/train_java.log 2>&1 
