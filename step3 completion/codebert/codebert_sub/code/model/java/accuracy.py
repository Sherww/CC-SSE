...
def hebing_sub():
    with open('test_1.output','r',encoding='utf-8')as f:
        ...
        for dat in data:
            rel=dat.split('\t')[1]
            rels.append(rel)
    with open('D:\\short_comment\\step3 completion\\codebert\\test_sub_input.txt','r',encoding='utf-8')as ff:
        data1=ff.readlines()
    with open('test_sub_output.txt','w',encoding='utf-8')as fff:        
...
def obj():
    ...
    print(f1_scores)
def sub():
    with open('test_sub_output.txt','r',encoding='utf-8')as f:
        data=f.readlines()
        result=[]
        nees=[]
        codes=[]
        for line in data:
            ...
            code=line.split(',')[0]+','+line.split(',')[1]
            codes.append(code)
    with open('D:\\short_comment\\step3 completion\\codebert\\test_sub.txt','r',encoding='utf-8')as f1:
        data=f1.readlines()
        test=[]
        nee2s=[]
        codes2=[]
        for line in data:
            ...
            code2=line.split(',')[0]+','+line.split(',')[1]
            codes2.append(code2)
    with open('D:\\short_comment\\step3 completion\\codebert\\result\\codebert_sub\\code\\model\\java\\yizhi_result\\result_sub_all_succ_or_fail.txt','w',encoding='utf-8')as f0:
        succ=[]
        for i in range(len(test)):
            if test[i] == result[i]:
        ...
        for i in range(len(succ)):
            f0.write(succ[i])            
    with open('D:\\short_comment\\step3 completion\\codebert\\result\\codebert_sub\\code\\model\\java\\yizhi_result\\result_sub_yizhi.txt','w',encoding='utf-8')as f2:
        a=[]
        b=[]
        c=[]
        d=[]
        ...
        for i in range(len(a)):
            f2.write(a[i])            
    with(open('D:\\short_comment\\step3 completion\\codebert\\test_sub_input.txt','r',encoding='utf-8'))as f4:
        e=f4.readlines()            
    with open('D:\\short_comment\\step3 completion\\codebert\\result\\codebert_sub\\code\\model\\java\\yizhi_result\\result_yizhi_sub.txt','w',encoding='utf-8')as f3:    
        c=[]
        d=[]
        for i in range(len(test)):
            if test[i] == result[i]:
